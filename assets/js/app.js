...
function visualize(theData) {
  ...
  // this will allow us to alter the values in functions and remove useless code.
  var xMin;
  var xMax;
  var yMin;
  var yMax;

  // This function allows us to set up tool-tip rules (see d3-tip.js).
  var toolTip = d3
    .tip()
    .attr("class", "d3-tip")
    .offset([40, -60])
  ...
  // PART 2: D.R.Y!
  // ==============
  // These functions remove some useless from later code.
  ...
  // This made it possible to add true mobile-responsiveness to our charts.
